label level1_geo:
    ...
    label game_pics:
        init:
            $ num_err = 3
            $ countries = ["mexico", "ukraine", "sweden", "iceland", "china", "india", "canada", "australia", "usa", "italy", "russia", "egypt", "japan", "uk", "france"]
            $ i = 0
            $ country_new = ''
            $ countries_dict = {"mexico": "мексика", "ukraine": "украина", "sweden": "швеция", "iceland": "исландия", "china": ["китай", "кнр"], "india": "индия", "canada": "канада", "australia": "австралия", "france": "франция", "usa": ["америка", "сша"], "italy": "италия", "russia": ["россия", "рф", "российская федерация"], "egypt": "египет", "japan": "япония", "uk": ["англия", "британия", "великобритания"]}
